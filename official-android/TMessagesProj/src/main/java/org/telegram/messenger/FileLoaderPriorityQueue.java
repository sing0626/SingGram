...
public class FileLoaderPriorityQueue {
    ...
    private void checkLoadingOperationInternal() {
        ...
        int max = type == TYPE_LARGE
                ? SingGramConfig.getBoostedLargeQueueMaxActiveOperations(messagesController.largeQueueMaxActiveOperations)
                : SingGramConfig.getBoostedSmallQueueMaxActiveOperations(messagesController.smallQueueMaxActiveOperations);
