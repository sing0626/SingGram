...
public class BuildVars {
    ...
    public static int APP_ID = BuildConfig.SINGGRAM_API_ID != 0 ? BuildConfig.SINGGRAM_API_ID : 4;
    public static String APP_HASH = BuildConfig.SINGGRAM_API_HASH.length() > 0 ? BuildConfig.SINGGRAM_API_HASH : "014b35b6184100b085b0d0572f9b5103";
    public static boolean SINGGRAM_FORCE_LIQUID_GLASS = BuildConfig.SINGGRAM_FORCE_LIQUID_GLASS;

    // Fork builds cannot use Telegram's Google project credentials. Keep these
    // empty so login uses normal Telegram code delivery instead of crashing in
    // SafetyNet/Google auth flows after authorization.
    ...
    public static boolean useInvoiceBilling() {
        return IS_BILLING_UNAVAILABLE || BillingController.billingClientEmpty || DEBUG_VERSION && false || ApplicationLoader.isStandaloneBuild() || isBetaApp() && false || isHuaweiStoreApp() || hasDirectCurrency();
    }
